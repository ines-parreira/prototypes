...
declare namespace Components {
    namespace Schemas {
        ...
        export interface AbilityRuleDto {
            /**
             * example:
             * manage
             */
        ...
        export interface ArticleInIntentDto {
            /**
             * The article ID
             * example:
             * 123
            ...
            id: number
            /**
             * The locale code of the article translation
             * example:
             * en-US
             */
            locale: string
            /**
             * The article translation version ID
             * example:
             * 456
             */
            ...
            title: string
            /**
             * The status of the article version
             * example:
             * published
             */
            status: 'published' | 'draft'
            /**
             * The template key used when creating the article
             * example:
             * ai_skill_1
             */
            template_key: string | null
        ...
        export interface IntentResponseDto {
             ...
             * linked
             */
            status: 'handover' | 'linked' | 'not_linked'
            /**
             * The help center ID where this intent belongs
             * example:
             * 789
             */
            help_center_id: number
            /**
             * List of articles linked to this intent
             * Empty array for orphan intents
             * example:
        ...
        export interface ListIntentsResponseDto {
            /**
             * List of all intents for the shop
             * example:
             * [{ name: "order::status", status: "linked", articles: [...] }]
             */
        ...
        export interface RebaseArticleTranslationDto {
            ...
            publisher_user_id?: number
            /**
             * Optional title override for the rebased published version.
             */
            title?: string
            /**
             * Optional content override for the rebased published version.
             */
            content?: string
            /**
        ...
        export interface UpdateIntentStatusDto {
            /**
             * The new status for the unlinked intent
             * example:
             * handover
             */
            status: 'not_linked' | 'handover'
        }
...
declare namespace Paths {
    ...
    namespace GetAgentAbilities {
        namespace Responses {
            export type $200 = Components.Schemas.AgentAbilityRulesDto
        }
    }
    ...
    namespace ListIntents {
        ...
        namespace Responses {
            export type $200 = Components.Schemas.ListIntentsResponseDto
    ...
    namespace UpdateIntentStatus {
        ...
        export type RequestBody = Components.Schemas.UpdateIntentStatusDto
        namespace Responses {
            export interface $200 {}
...
export interface OperationMethods {
    ...
    'getAgentAbilities'(
        ...
        data?: any,
        config?: AxiosRequestConfig,
    ): OperationResponse<Paths.GetAgentAbilities.Responses.$200>
    /**
