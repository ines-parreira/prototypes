...
description: >-
  Add a new metric to a ConfigurableGraph chart, replace an existing chart with
  a ConfigurableGraph, or create a new ConfigurableGraph chart from scratch.
  Handles scope query factories, metric name registration, chart config, and
  tests for both line and bar chart types.
---
