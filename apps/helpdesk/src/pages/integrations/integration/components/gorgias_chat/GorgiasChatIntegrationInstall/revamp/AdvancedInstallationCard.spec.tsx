...
jest.mock(
    'pages/integrations/integration/components/gorgias_chat/GorgiasChatIntegrationInstall/revamp/AdvancedInstallationSidePanel/AdvancedInstallationSidePanel',
    () => ({
        __esModule: true,
