...
describe('BarChartTooltip', () => {
    ...
    it('should format large values with locale string', () => {
        render(<BarChartTooltip name="Test" value={999999} color="#000000" />)

        expect(screen.getByText('999,999')).toBeInTheDocument()
    })

    it('should format thousand values with comma separator', () => {
        render(<BarChartTooltip name="Test" value={1000} color="#000000" />)

        expect(screen.getByText('1,000')).toBeInTheDocument()
    })

    it('should format million values with comma separators', () => {
    ...
    it('should render color dot with correct dimensions', () => {
        ...
        const dot = container.querySelector('[style*="width"]')
