...
import { fetchPerformanceChannelsEmailAgentMetrics } from 'domains/reporting/pages/performance/channels/email/hooks/agentBreakdown/usePerformanceChannelsEmailAgentMetrics'
...
jest.mock(
    ...
    () => ({
        fetchPerformanceChannelsEmailAgentMetrics: jest.fn(),
    }),
)
...
const mockFetch = assumeMock(fetchPerformanceChannelsEmailAgentMetrics)
...
const MOCK_FILE_NAME =
    '2024-01-01_2024-01-31-performance-channels-email_by-agent.csv'
const MOCK_CSV = '"Agent","Average CSAT"\r\n"Alice","4.5"'
...
describe('useDownloadPerformanceChannelsEmailAgentData', () => {
    beforeEach(() => {
        jest.clearAllMocks()
    ...
    it('calls fetchPerformanceChannelsEmailAgentMetrics with filters, timezone, and agents', async () => {
        renderHook(() => useDownloadPerformanceChannelsEmailAgentData())
