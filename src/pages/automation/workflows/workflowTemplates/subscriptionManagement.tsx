...
export const SUBSCRIPTION_MANAGEMENT: WorkflowTemplate = {
    ...
    getConfiguration: (
        ...
        b.insertChoiceAndMessagesStepAndSelect('Change Frequency', [
            {
                content: {
...
3. Confirm your changes`,
        ...
        b.selectParentStep()
        b.selectParentStep()
        b.insertChoiceAndMessagesStepAndSelect('Change Products', [
            {
                content: {
...
4. Confirm your selection`,
        ...
        b.selectParentStep()
        b.selectParentStep()
        b.insertChoiceAndMessagesStepAndSelect('Update delivery details', [
            {
                content: {
        ...
        b.insertChoicesStepAndSelect()
        b.insertChoiceAndMessagesStepAndSelect('Change my shipping address', [
            {
                content: {
...
4. Confirm your selection`,
        ...
        b.selectParentStep()
        b.selectParentStep()
        b.insertChoiceAndMessagesStepAndSelect('Update delivery instructions', [
            {
                content: {
...
4. Save changes`,
        ...
        b.selectParentStep()
        b.selectParentStep()
        b.insertChoiceAndMessagesStepAndSelect('Change payment information', [
            {
                content: {
...
4. Confirm your selection`,
        ...
        b.selectParentStep()
        b.selectParentStep()
        b.insertChoiceAndMessagesStepAndSelect('Cancel subscription', [
            {
                content: {
