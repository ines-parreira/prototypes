...
const useAblyAgentsOnlineStatusMock = assumeMock(useAblyAgentsOnlineStatus)
...
describe('LiveVoiceAgentsList', () => {
    beforeEach(() => {
        ...
        useAblyAgentsOnlineStatusMock.mockReturnValue({
            onlineAgents: {},
        })
    })
    ...
    it('should use ably online statuses if FF is enabled', () => {
