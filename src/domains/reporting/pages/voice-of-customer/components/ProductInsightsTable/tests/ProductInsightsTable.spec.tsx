...
} from 'domains/reporting/pages/voice-of-customer/components/ProductInsightsTable/ProductInsightsTable'
import {
    columnsOrder,
...
jest.mock(
    'domains/reporting/pages/voice-of-customer/components/ProductInsightsTable/ProductInsightsCellContent',
)
const ProductInsightsCellContentMock = assumeMock(ProductInsightsCellContent)

jest.mock(
    'domains/reporting/pages/voice-of-customer/components/ProductInsightsTable/ProductInsightsHeaderCellContent',
)
const ProductInsightsHeaderCellContentMock = assumeMock(
    ProductInsightsHeaderCellContent,
)

jest.mock('domains/reporting/hooks/useProductInsightsTableConfigSetting')
const useProductInsightsTableSettingMock = assumeMock(
    useProductInsightsTableSetting,
)
jest.mock('domains/reporting/hooks/voice-of-customer/useSortedProducts')
