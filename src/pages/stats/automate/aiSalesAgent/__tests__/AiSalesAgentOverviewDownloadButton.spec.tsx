...
import useAiSalesAgentOverviewReportData from 'pages/stats/automate/aiSalesAgent/hooks/aiSalesAgentReportingService'
...
jest.mock(
    'pages/stats/automate/aiSalesAgent/hooks/aiSalesAgentReportingService',
)
