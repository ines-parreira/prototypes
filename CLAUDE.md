...
- Run tests for a specific path with `pnpm test:helpdesk <path>`
- Update the snapshots with `pnpm test:helpdesk -u` for the helpdesk app
- Update the snapshots with `pnpm test:all -u` for all packages
- Update the snapshots with `pnpm test:affected -u` for all affected packages
- Update the snapshots for a specific path with `pnpm test:helpdesk <path> -u`

### Linting

- Lint code with `pnpm lint:helpdesk` for the helpdesk app
