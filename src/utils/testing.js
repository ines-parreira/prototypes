 ...
 */
export const mockStore = (store: MockStore) => configureMockStore(middlewares)(store)
 ...
 */
export const shallowWithStore = (component: Element<*>, store: MockStore) => shallow(component, {context: {store}})
