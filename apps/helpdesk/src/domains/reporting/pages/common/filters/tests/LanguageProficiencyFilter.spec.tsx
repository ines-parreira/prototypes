...
describe('LanguageProficiency', () => {
    ...
    it('should render LanguageProficiencyFilter component just fine if value is undefined', () => {
        render(
            <LanguageProficiencyFilter
                onRemove={mockedRemove}
                value={undefined}
    ...
    it('should dispatch cleanFilters action and call segment analytics log event on filter dropdown close', () => {
        ...
        expect(logEvent).toHaveBeenCalledWith(SegmentEvent.StatFilterSelected, {
            name: FilterKey.LanguageProficiency,
            logical_operator:
                LogicalOperatorLabel[
    ...
    describe('LanguageProficiencyFilterWithState', () => {
        it('should render LanguageProficiencyFilterWithState component', () => {
            const spy = jest.spyOn(
                statsSlice,
                'mergeStatsFiltersWithLogicalOperator',
            )

            render(<LanguageProficiencyFilterWithState />, {
                storeState: defaultState,
            })
            ...
            expect(spy).toHaveBeenCalledWith({
                [FilterKey.LanguageProficiency]: withLogicalOperator([]),
            })
        })
    })
    ...
    describe('LanguageProficiencyFilterWithSavedState', () => {
        it('should render LanguageProficiencyFilterWithSavedState component', () => {
            ...
            render(<LanguageProficiencyFilterWithSavedState />, {
                storeState: defaultState,
            })
            userEvent.click(screen.getByText(FILTER_VALUE_PLACEHOLDER))
            userEvent.click(screen.getByText(FILTER_SELECT_ALL_LABEL))
