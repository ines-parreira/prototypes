...
export const CSM_TARGET_KNOWN_RETURN_REASONS_ON_PRODUCT_DURING_BUSINESS_HOURS: CampaignTemplate =
    {
        slug: 'csm-target-known-return-reasons-on-product-during-business-hours',
        name: '[Prevent Returns] Target known return reasons on product (PDP triggered) during business hours',
        onboarding: false,
        ...
        getConfiguration: (): Promise<CampaignConfiguration> => {
            ...
            const builder = new CampaignConfigurationBuilder(
                ...
                {
                    name: CSM_TARGET_KNOWN_RETURN_REASONS_ON_PRODUCT_DURING_BUSINESS_HOURS.name,
                    template_id:
