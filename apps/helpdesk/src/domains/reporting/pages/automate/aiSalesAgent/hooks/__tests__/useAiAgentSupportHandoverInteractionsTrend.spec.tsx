...
import {
    fetchAiAgentSupportHandoverInteractionsTrend,
    useAiAgentSupportHandoverInteractionsTrend,
} from 'domains/reporting/pages/automate/aiSalesAgent/hooks/useAiAgentSupportHandoverInteractionsTrend'
...
const mockAiSupportHandoverInteractionsV2QueryFactory = assumeMock(
    aiSupportHandoverInteractionsV2QueryFactory,
)

describe('aiAgentSupportHandoverInteractionsTrend', () => {
    const currentQuery = {
    ...
    beforeEach(() => {
        mockAiSupportHandoverInteractionsV2QueryFactory
            .mockReturnValueOnce(currentQuery)
            .mockReturnValueOnce(prevQuery)
    })

    describe('useAiAgentSupportHandoverInteractionsTrend', () => {
    ...
    describe('fetchAiAgentSupportHandoverInteractionsTrend', () => {
        beforeEach(() => {
            mockAiSupportHandoverInteractionsV2QueryFactory
                .mockReturnValueOnce(currentQuery)
                .mockReturnValueOnce(prevQuery)
        ...
        it('should return data from fetchStatsMetricTrend', async () => {
            ...
            const result = await fetchAiAgentSupportHandoverInteractionsTrend(
                statsFilters,
                timezone,
            )
        ...
        it('should call fetchStatsMetricTrend with current and previous period queries', async () => {
            ...
            await fetchAiAgentSupportHandoverInteractionsTrend(
                statsFilters,
                timezone,
            )
