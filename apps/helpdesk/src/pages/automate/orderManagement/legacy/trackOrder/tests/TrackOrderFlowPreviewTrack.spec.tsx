...
import { TrackOrderFlowPreview as TrackOrderFlowPreviewTrack } from '../TrackOrderFlowPreviewTrack'
...
describe('TrackOrderFlowPreviewTrack', () => {
    beforeEach(() => {
        jest.clearAllMocks()
    ...
    it('should render without crashing', () => {
        render(<TrackOrderFlowPreviewTrack />)
    ...
    it('should not show Preview button initially while animation is playing', () => {
        render(<TrackOrderFlowPreviewTrack />)
        expect(
