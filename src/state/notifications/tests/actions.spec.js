    ...
    describe('notifications', () => {
        ...
        it('should calculate dismiss time depending on content', () => {
            store.dispatch(notify({
                ...
                message: 'It is commonly topped with a selection of meats, vegetables and condiments.'
            }))
            const expectedActions = store.getActions()
        ...
        it('should set title as content, if content not defined', () => {
            const title = 'Pizza is a yeasted flatbread typically topped with tomato sauce and cheese and baked in an oven.'
        ...
        it('should not add duplicate notifications', () => {
            const notification = store.dispatch(notify({
                id: 12345,
