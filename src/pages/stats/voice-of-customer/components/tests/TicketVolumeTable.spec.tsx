...
import {
    ColumnLabels,
    TicketVolumeTable,
} from 'pages/stats/voice-of-customer/charts/ChangeInTicketVolumeChart/TicketVolumeTable'
...
jest.mock('hooks/reporting/voice-of-customer/useTicketsDistributionPerProduct')
