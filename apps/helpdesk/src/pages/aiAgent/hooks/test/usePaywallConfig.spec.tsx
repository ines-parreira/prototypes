...
describe('usePaywallConfig', () => {
    ...
    it('should return the correct config for AIAgentPaywallFeatures.ShoppingAssistantTrialSetup', () => {
        const { result } = renderHook(() =>
            usePaywallConfig(
    ...
    it('should return the correct config for AIAgentPaywallFeatures.Upgrade', () => {
        const { result } = renderHook(() =>
            usePaywallConfig(AIAgentPaywallFeatures.Upgrade),
        )
