...
describe('CommunicationSkillsFilter', () => {
    ...
    it('should remove the Communication Skills filter', () => {
        renderComponent()
    ...
    it('should dispatch cleanFilters action and call segment analytics log event on filter dropdown close', () => {
        ...
        expect(logEvent).toHaveBeenCalledWith(SegmentEvent.StatFilterSelected, {
            name: FilterKey.CommunicationSkills,
            logical_operator:
                LogicalOperatorLabel[
    ...
    describe('CommunicationSkillsFilterWithState', () => {
        it('should render CommunicationSkillsFilterWithState component', () => {
            ...
            render(<CommunicationSkillsFilterWithState />, {
                storeState: defaultState,
            })
    ...
    describe('CommunicationSkillsFilterWithSavedState', () => {
        it('should render CommunicationSkillsFilterWithSavedState component', () => {
            ...
            render(<CommunicationSkillsFilterWithSavedState />, {
                storeState: defaultState,
            })
            userEvent.click(screen.getByText(FILTER_VALUE_PLACEHOLDER))
            userEvent.click(screen.getByText(FILTER_SELECT_ALL_LABEL))
