...
export const mockPhoneNumbers: Record<string, NewPhoneNumber> = {
    '1': {
        ...
        integrations: [{ id: 'sms-1', type: 'sms' }],
    ...
    '2': {
        ...
        integrations: [{ id: 'sms-2', type: 'sms' }],
    } as unknown as NewPhoneNumber,
    '3': {
        id: '3',
        name: 'Regular Phone',
        ...
        capabilities: { sms: true, voice: true },
        integrations: [{ id: 'sms-3', type: 'sms' }],
    } as unknown as NewPhoneNumber,
    '4': {
        id: '4',
        name: '[MKT] Phone 4',
        ...
        integrations: [{ id: 'sms-4', type: 'sms' }],
    } as unknown as NewPhoneNumber,
    '5': {
        id: '5',
        name: '[MKT] Phone 5',
        ...
        capabilities: { sms: true, voice: true },
        integrations: [{ id: 'voice-5', type: 'voice' }],
    } as unknown as NewPhoneNumber,
}
