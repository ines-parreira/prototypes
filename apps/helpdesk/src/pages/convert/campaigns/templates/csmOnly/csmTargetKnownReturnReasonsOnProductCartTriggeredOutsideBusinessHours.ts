...
export const CSM_TARGET_KNOWN_RETURN_REASONS_ON_PRODUCT_CART_TRIGGERED_OUTSIDE_BUSINESS_HOURS: CampaignTemplate =
    {
        slug: 'csm-target-known-return-reasons-on-product-cart-triggered-outside-business-hours',
        name: '[Prevent Returns] Target known return reasons on product (cart triggered) outside business hours',
        onboarding: false,
        ...
        getConfiguration: (): Promise<CampaignConfiguration> => {
            ...
            const builder = new CampaignConfigurationBuilder(
                ...
                {
                    name: CSM_TARGET_KNOWN_RETURN_REASONS_ON_PRODUCT_CART_TRIGGERED_OUTSIDE_BUSINESS_HOURS.name,
                    template_id:
