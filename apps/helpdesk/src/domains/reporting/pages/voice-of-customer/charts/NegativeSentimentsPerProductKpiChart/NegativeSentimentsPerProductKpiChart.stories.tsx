...
const storyConfig: Meta = {
    title: 'Stats/VoiceOfCustomer/NegativeSentimentsPerProductKpiChart',
    component: NegativeSentimentsPerProductKpiChart,
    parameters: {
...
const Template = () => {
    return <NegativeSentimentsPerProductKpiChart />
}
