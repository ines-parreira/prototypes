...
import css from './TicketTagDropdown.less'
...
const TicketTagDropdown = ({
    ...
    const toggle = (e?: KeyboardEvent, visible?: boolean) => {
...
export default TicketTagDropdown
