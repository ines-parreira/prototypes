...
describe('AgentAvailabilityTableCell Utilities', () => {
    describe('getColumnValue', () => {
        ...
        it('should return online from StatusBreakdown', () => {
            const breakdown: StatusBreakdown = {
                total: 1800,
                online: 1000,
                offline: 800,
            }
            expect(getColumnValue(breakdown)).toBe(1000)
        })

        it('should return zero online from StatusBreakdown with zero values', () => {
            const breakdown: StatusBreakdown = {
                total: 0,
                online: 0,
                offline: 0,
