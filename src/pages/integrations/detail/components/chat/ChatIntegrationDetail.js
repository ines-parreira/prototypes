        ...
        return (
            <div>
                ...
                <pre className="ui info message">
                    ...
                    {`<script>Smooch.init({appToken: '${integration.getIn(['meta', 'app_token'])}'});</script>`}
                </pre>
                <p>
        ...
        return (
            <div className="ui grid">
                <div className="ten wide column">
                    ...
                    <p>Let's add a Chat integration, so you can chat with customers on your website.</p>
