...
import {
    VoCSidePanel,
    VoCSidePanelTabs,
} from 'pages/stats/voice-of-customer/components/VoCSidePanel/VoCSidePanel'
import { TREND_OVERVIEW_LABEL } from 'pages/stats/voice-of-customer/constants'
import { InsightsTab } from 'pages/stats/voice-of-customer/side-panel/InsightsTab/InsightsTab'
...
jest.mock('pages/stats/voice-of-customer/components/ProductHeader')
const ProductHeaderMock = assumeMock(ProductHeader)

jest.mock('pages/stats/voice-of-customer/side-panel/InsightsTab/InsightsTab')
...
jest.mock(
    'pages/stats/voice-of-customer/side-panel/TrendOverviewReport/TrendOverviewReport',
)
