...
import { ProductInsightsCellContent } from 'pages/stats/voice-of-customer/components/ProductInsightsTable/ProductInsightsCellContent'
import { ProductInsightsHeaderCellContent } from 'pages/stats/voice-of-customer/components/ProductInsightsTable/ProductInsightsHeaderCellContent'
import {
    NO_DATA_HEADING,
    NO_DATA_SUBHEADING,
    ProductInsightsTable,
} from 'pages/stats/voice-of-customer/components/ProductInsightsTable/ProductInsightsTable'
import {
    columnsOrder,
...
jest.mock(
    'pages/stats/voice-of-customer/components/ProductInsightsTable/ProductInsightsCellContent',
)
const ProductInsightsCellContentMock = assumeMock(ProductInsightsCellContent)

jest.mock(
    'pages/stats/voice-of-customer/components/ProductInsightsTable/ProductInsightsHeaderCellContent',
)
