...
import { GorgiasChatIntegrationListRevamp } from 'pages/integrations/integration/components/gorgias_chat/revamp/IntegrationList/GorgiasChatIntegrationList'
...
jest.mock(
    'pages/integrations/integration/components/gorgias_chat/revamp/IntegrationList/components/ChatIntegrationsTable/ChatIntegrationsTable',
    () => ({
