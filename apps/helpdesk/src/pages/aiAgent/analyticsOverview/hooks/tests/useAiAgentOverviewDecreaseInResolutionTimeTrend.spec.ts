...
import {
    fetchAiAgentOverviewDecreaseInResolutionTimeTrend,
    useAiAgentOverviewDecreaseInResolutionTimeTrend,
} from 'pages/aiAgent/analyticsOverview/hooks/useAiAgentOverviewDecreaseInResolutionTimeTrend'
...
describe('useAiAgentOverviewDecreaseInResolutionTimeTrend', () => {
...
describe('fetchAiAgentOverviewDecreaseInResolutionTimeTrend', () => {
    it('should return data from fetchStatsMetricTrend', async () => {
        ...
        const result = await fetchAiAgentOverviewDecreaseInResolutionTimeTrend(
            statsFilters,
            timezone,
        )
