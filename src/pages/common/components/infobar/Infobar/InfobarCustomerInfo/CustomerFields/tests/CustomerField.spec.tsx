...
describe('CustomerField', () => {
    ...
    it('should render a tooltip with value', async () => {
        render(<CustomerField {...defaultProps} />)
    ...
    it("should call the mutation with the new value when CustomFieldInput's onChange is called with a dropdown input type", () => {
        render(
            <CustomerField
                {...defaultProps}
    ...
    it('should not call the mutation when queryValue of a dropdown input type changes', () => {
