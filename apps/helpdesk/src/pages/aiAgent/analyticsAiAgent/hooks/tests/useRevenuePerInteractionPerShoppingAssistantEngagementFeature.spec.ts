...
} from '../useRevenuePerInteractionPerShoppingAssistantEngagementFeature'
...
jest.mock('domains/reporting/models/scopes/aiSalesAgentActivity', () => ({
    aiAgentSalesRevenuePerInteractionPerEngagementTypeQueryV2Factory: jest.fn(),
}))
...
).aiAgentSalesRevenuePerInteractionPerEngagementTypeQueryV2Factory as jest.Mock
...
const defaultAllValues = [
    { dimension: 'search_bar', value: 29.2, decile: null },
    { dimension: 'ask_anything', value: 21.8, decile: null },
]

describe('useRevenuePerInteractionPerShoppingAssistantEngagementFeature', () => {
    beforeEach(() => {
        jest.clearAllMocks()
...
describe('fetchRevenuePerInteractionPerShoppingAssistantEngagementFeature', () => {
    beforeEach(() => {
        jest.clearAllMocks()
        mockQueryFactory.mockReturnValue(MOCK_QUERY)
    ...
    it('calls the query factory with filters and timezone', async () => {
        await fetchRevenuePerInteractionPerShoppingAssistantEngagementFeature(
            MOCK_STATS_FILTERS,
            MOCK_TIMEZONE,
        )
