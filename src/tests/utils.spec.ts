...
`)
    ...
    describe('castReactPlayerContainersForUnsupportedSources()', () => {
        it('should properly cast videos to hyperlinks and text', () => {
            ...
            const dataset: {
                ...
                // [video]
                {
                    rawHtml: `<figure><div class="react-player-container" data-src="${randomUrls[0]}"></figure>`,
                    expectedHtmlHyperLinks: `<div><a href="${randomUrls[0]}">${randomUrls[0]}</a></div>`,
                    expectedHtmlNoHyperLinks: `<div>${randomUrls[0]}</div>`,
                },
                // [video] [video]
                {
                    rawHtml: `<figure><div class="react-player-container" data-src="${randomUrls[0]}"></figure><div><br></div><figure><div class="react-player-container" data-src="${randomUrls[1]}"></figure>`,
                ...
                {
                    rawHtml: `<figure style="display:inline-block;margin:0"><div class="react-player-container" data-src="${randomUrls[0]}"></figure><div><br></div><figure style="display:inline-block;margin:0"><div class="react-player-container" data-src="${randomUrls[1]}"></figure>`,
                    expectedHtmlHyperLinks: `<div><a href="${randomUrls[0]}">${randomUrls[0]}</a></div><div><br></div><div><a href="${randomUrls[1]}">${randomUrls[1]}</a></div>`,
                    expectedHtmlNoHyperLinks: `<div>${randomUrls[0]}</div><div><br></div><div>${randomUrls[1]}</div>`,
                },
                // [text] [video] [image] [text] [video] [link] [text] [space] [image]
                {
                    rawHtml: `<div>text1</div><figure style="display:inline-block;margin:0"><div class="react-player-container" data-src="https://www.youtube.com/watch?v=4sLFpe-xbhk" width="600"></figure><div><a href="https://test-videos.co.uk/vids/bigbuckbunny/webm/vp8/360/Big_Buck_Bunny_360_10s_1MB.webm" target="_blank">https://test-videos.co.uk/vids/bigbuckbunny/webm/vp8/360/Big_Buck_Bunny_360_10s_1MB.webm</a></div><div>text2</div><figure style="display:inline-block;margin:0"><div class="react-player-container" data-src="https://test-videos.co.uk/vids/bigbuckbunny/webm/vp8/360/Big_Buck_Bunny_360_10s_1MB.webm" width="600"></figure><div>test3beforespaces</div><div><br></div><div><br></div><div>tests4afterspaces</div><div><br></div><figure style="display:inline-block;margin:0"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRmcdHNojpj5mzs9E-WWvoyLJ6Bqul4t8zlxVS5Kwa3X0Vgy6jLr8VUaxVMIWE1ain5ttk&usqp=CAU" width="400" style="max-width: 100%"></figure><div><br></div>`,
            ...
            for (const data of dataset) {
                expect(
                    utils.castReactPlayerContainersForUnsupportedSources({
                        html: data.rawHtml,
