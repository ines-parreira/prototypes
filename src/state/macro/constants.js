...
export const ADD_ATTACHMENTS_MACRO_START = 'ADD_ATTACHMENTS_MACRO_START'
export const ADD_ATTACHMENTS_MACRO_SUCCESS = 'ADD_ATTACHMENTS_MACRO_SUCCESS'
export const ADD_ATTACHMENTS_MACRO_ERROR = 'ADD_ATTACHMENTS_MACRO_ERROR'

export const DELETE_ATTACHMENT_MACRO = 'DELETE_ATTACHMENT_MACRO'
