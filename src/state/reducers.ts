...
import currentAccountReducer from './currentAccount/reducers.js'
import currentUserReducer from './currentUser/reducers.js'
import customersReducer from './customers/reducers.js'
import entities from './entities/reducers'
import facebookAdsReducer from './facebookAds/reducers.js'
import HTTPIntegrationEventsReducer from './HTTPIntegrationEvents/reducers.js'
import infobarActionsReducer from './infobarActions/reducers.js'
import infobarReducer from './infobar/reducers.js'
import integrationsReducer from './integrations/reducers.js'
import layoutReducer from './layout/reducers.js'
import macrosReducer from './macro/reducer.js'
