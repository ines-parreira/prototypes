...
description: >-
  Add a new analytics metric breakdown table to the AI Agent Analytics dashboard
  (analyticsOverview or analyticsAiAgent). Scaffolds scope queries, per-metric
  hooks, aggregator hook, download hook, component files, and wires up CSV
  export and layout registration.
---
