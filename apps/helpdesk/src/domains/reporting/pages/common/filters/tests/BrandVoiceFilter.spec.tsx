...
describe('BrandVoice', () => {
    ...
    it('should render BrandVoiceFilter component just fine if value is undefined', () => {
        ...
        expect(
            screen.getByText(FilterLabels[FilterKey.BrandVoice]),
        ).toBeInTheDocument()
    ...
    describe('BrandVoiceFilterWithState', () => {
        it('should render BrandVoiceFilterWithState component', () => {
            ...
            expect(spy).toHaveBeenCalledWith({
                [FilterKey.BrandVoice]: withLogicalOperator([]),
            })
        })
    })

    describe('BrandVoiceFilterWithSavedState', () => {
        it('should render BrandVoiceFilterWithSavedState component', () => {
