...
describe('InternalCompliance', () => {
    ...
    it('should render InternalComplianceFilter component just fine if value is undefined', () => {
        render(
            <InternalComplianceFilter
                onRemove={mockedRemove}
                value={undefined}
    ...
    it('should dispatch cleanFilters action and call segment analytics log event on filter dropdown close', () => {
        ...
        expect(logEvent).toHaveBeenCalledWith(SegmentEvent.StatFilterSelected, {
            name: FilterKey.InternalCompliance,
            logical_operator:
                LogicalOperatorLabel[
    ...
    describe('InternalComplianceFilterWithState', () => {
        it('should render InternalComplianceFilterWithState component', () => {
            const spy = jest.spyOn(
                statsSlice,
                'mergeStatsFiltersWithLogicalOperator',
            )

            render(<InternalComplianceFilterWithState />, {
                storeState: defaultState,
            })
    ...
    describe('InternalComplianceFilterWithSavedState', () => {
        it('should render InternalComplianceFilterWithSavedState component', () => {
            ...
            render(<InternalComplianceFilterWithSavedState />, {
                storeState: defaultState,
            })
            userEvent.click(screen.getByText(FILTER_VALUE_PLACEHOLDER))
            userEvent.click(screen.getByText(FILTER_SELECT_ALL_LABEL))
