...
description: Generate a new helpdesk-web-app monorepo package under packages/{name}. Use when the user asks to create, scaffold, or codegen a new @repo package.
---
