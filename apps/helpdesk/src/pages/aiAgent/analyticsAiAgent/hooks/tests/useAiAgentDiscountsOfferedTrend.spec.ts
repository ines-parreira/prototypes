...
import {
    fetchAiAgentDiscountsOfferedTrend,
    useAiAgentDiscountsOfferedTrend,
} from 'pages/aiAgent/analyticsAiAgent/hooks/useAiAgentDiscountsOfferedTrend'
...
assumeMock(discountCodesOfferedQueryV2Factory)

describe('aiAgentDiscountsOfferedTrend', () => {
    describe('useAiAgentDiscountsOfferedTrend', () => {
        it('should return data from useStatsMetricTrend', () => {
            ...
            const { result } = renderHook(() =>
                useAiAgentDiscountsOfferedTrend(statsFilters, timezone),
            )
    ...
    describe('fetchAiAgentDiscountsOfferedTrend', () => {
        it('should return data from fetchStatsMetricTrend', async () => {
            ...
            const result = await fetchAiAgentDiscountsOfferedTrend(
                statsFilters,
                timezone,
            )
