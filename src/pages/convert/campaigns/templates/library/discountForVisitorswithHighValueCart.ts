...
export const DISCOUNT_HIGH_VALUE_CARTS: CampaignTemplate = {
    ...
    getConfiguration: (): Promise<CampaignConfiguration> => {
        // TODO: Replace with discount code generated by the backend
        const discountCode = 'FORYOU10'
        ...
        const b = new CampaignConfigurationBuilder(DISCOUNT_HIGH_VALUE_CARTS, {
            ...
            message_html: `<div>🍀 You&#x27;re lucky today: <strong>10% off</strong> on your order over $150, with <strong>code <a data-discount-code="${discountCode}" href="https://${shopName}.myshopify.com/discount/${discountCode}" target="_blank" rel="noreferrer">${discountCode}</a> </strong></div>`,
