                    ...
                    <BannerNotification
                        actionHTML={
                            <Link to="/app/stats/support-performance-agents">
                                <i className="material-icons">refresh</i> Switch
                                To New Version
                            </Link>
                        }
                        closable
                        dismissible={false}
                        message="This is the old Agents page, which uses our old method of computing metrics and may not fully represent your performance."
