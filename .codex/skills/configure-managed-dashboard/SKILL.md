...
description: >-
  ...
  shared trend-card tests, and (C) wiring a configurable bar/line graph
  (page-specific dimension config, graph component, ReportConfig entry, layout
  section, tests). Use when adding a metric card or a configurable chart to a
  managed dashboard such as Performance Overview.
---
