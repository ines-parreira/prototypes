...
import { CampaignRevenueShareStat } from 'domains/reporting/pages/convert/components/CampaignRevenueShareStat/CampaignRevenueShareStat'
...
jest.mock('domains/reporting/pages/convert/hooks/stats/useGetRevenueShareChart')
