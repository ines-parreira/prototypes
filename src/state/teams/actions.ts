 ...
 * Get paginated teams
 */
export const fetchTeamsPagination =
    (page = 1) =>
...
export const addTeamMember =
    ...
    (dispatch: StoreDispatch): Promise<ReturnType<StoreDispatch>> => {
        return client
            .post<MemberAddedTeam>(`/api/teams/${teamId}/members/`, {
                id: userId,
            })
            .then((json) => json?.data)
            .then(
 ...
 */
export const deleteTeamMemberList =
    (teamId: number, userIds: Set<number>) =>
    (dispatch: StoreDispatch): Promise<ReturnType<StoreDispatch>> => {
        return client
            .delete(`/api/teams/${teamId}/members/`, {
                data: {ids: userIds.toJS()},
            })
            .then(
                () => {
                    void dispatch(
