        ...
        <div className="full-width">
            ...
            {hasSelfServiceV1Features || hasAutomationAddOn ? (
                <Container fluid className="page-container">
                    ...
                    integrations' settings page for better visibility and
                    clarity. Access the Self-service settings by clicking the
                    "Self-service" menu item in the settings sidebar.
                    Self-service features will be specific to each connected
                    Shopify store and available in different channels.
                    <br />
                    <br />
                    Read more about it{' '}
                    <a
