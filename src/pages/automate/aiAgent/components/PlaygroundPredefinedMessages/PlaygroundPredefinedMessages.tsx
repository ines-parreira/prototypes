...
const PREDEFINED_MESSAGES: PredefinedMessage[] = [
    ...
    },
    {
        ...
        content:
            "Hi there,<br/>I hope you're doing well! I'm interested in purchasing some products from your website. Before I proceed, I wanted to know if you offer international shipping. Could you please let me know if you ship to [country] and any details related to international shipping costs and delivery times?<br/>Best regards",
    },
    {
