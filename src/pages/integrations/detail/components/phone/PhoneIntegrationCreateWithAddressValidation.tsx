...
import rawCountryOptions from './options/countries-with-address.json'
...
export default function PhoneIntegrationCreate({actions}: Props): JSX.Element {
    ...
    const shouldShowType = country !== PhoneCountry.AU
                    ...
                    <Col lg={6} xl={7}>
                        {shouldValidateAddress(country) && (
                            <Alert showIcon className="mt-3 mb-4">
                                ...
                                require address verification. French numbers are
                                also available through the{' '}
                                <a href="#">French number request form.</a>
                            </Alert>
                        )}
