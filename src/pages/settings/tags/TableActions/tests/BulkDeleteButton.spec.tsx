...
describe('<BulkDeleteButton />', () => {
    ...
    it('should delete tags after confirmation prompt', () => {
        ...
        expect(
            ...
            'You are about to delete 1 tag: refund.It will be removed from all tickets.Historical Statistics for this tag will be lost.It will not be possible to add the tag back on the tickets they were on.'
        )
    ...
    it('should display analytics saved filters message', () => {
        mockFlags({
