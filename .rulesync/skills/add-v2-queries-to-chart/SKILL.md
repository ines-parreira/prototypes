...
description: >-
    Adds v2 query factories to an existing stats scope and wires them into the
    chart's hook(s). Use after /implement-stats-scope when the scope exists but
    has no query factories yet.
argument-hint: <chart-component-path-or-hook-name>
---
