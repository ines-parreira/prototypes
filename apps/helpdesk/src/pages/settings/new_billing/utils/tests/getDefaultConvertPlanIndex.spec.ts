...
describe('getDefaultConvertPlanIndex', () => {
    it.each([
        ...
        [[], Cadence.Month, 'Pro', -1],
        [convertAvailablePlans, Cadence.Month, 'Unknown', 3],
        [convertAvailablePlans, Cadence.Month, 'Starter', 3],
        [convertAvailablePlans, Cadence.Month, 'Basic', 3],
        [convertAvailablePlans, Cadence.Month, 'Pro', 3],
        [convertAvailablePlans, Cadence.Month, 'Advanced', 5],
        [convertAvailablePlans, Cadence.Month, 'Custom', 10],
        [convertAvailablePlans, Cadence.Year, 'Starter', 6],
        [convertAvailablePlans, Cadence.Year, 'Advanced', 14],
    ])(
