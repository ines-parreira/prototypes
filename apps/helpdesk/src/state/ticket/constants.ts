...
export const SET_IN_TICKET_SUGGESTION_STATE = 'SET_IN_TICKET_SUGGESTION_STATE'
...
export const MERGE_CUSTOMER_ECOMMERCE_DATA_SHOPPER =
    'MERGE_CUSTOMER_ECOMMERCE_DATA_SHOPPER'
export const MERGE_CUSTOMER_ECOMMERCE_DATA_SHOPPER_ADDRESS =
    'MERGE_CUSTOMER_ECOMMERCE_DATA_SHOPPER_ADDRESS'
export const MERGE_CUSTOMER_ECOMMERCE_DATA_ORDER =
    'MERGE_CUSTOMER_ECOMMERCE_DATA_ORDER'
export const MAX_ORDERS_PER_SHOPPER = 20
export const MAX_ADDRESSES_PER_SHOPPER = 10
...
export const UPDATE_CUSTOM_FIELD_PREDICTION = 'UPDATE_CUSTOM_FIELD_PREDICTION'
export const SET_INVALID_CUSTOM_FIELDS_TO_ERRORED =
    'SET_INVALID_CUSTOM_FIELDS_TO_ERRORED'

export const RESTORE_TICKET_DRAFT = 'RESTORE_TICKET_DRAFT'
export const RESTORE_TICKET_DRAFT_APPLY_MACRO =
    'RESTORE_TICKET_DRAFT_APPLY_MACRO'

export const SET_HAS_ATTEMPTED_TO_CLOSE_TICKET =
    'SET_HAS_ATTEMPTED_TO_CLOSE_TICKET'

export const SET_SHOULD_DISPLAY_ALL_FOLLOW_UPS =
    'SET_SHOULD_DISPLAY_ALL_FOLLOW_UPS'
