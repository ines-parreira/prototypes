...
import {
    fetchAiAgentProductRecommendationsTrend,
    useAiAgentProductRecommendationsTrend,
} from 'pages/aiAgent/analyticsAiAgent/hooks/useAiAgentProductRecommendationsTrend'
...
assumeMock(recommendedProductCountQueryV2Factory)

describe('aiAgentProductRecommendationsTrend', () => {
    describe('useAiAgentProductRecommendationsTrend', () => {
        it('should return data from useStatsMetricTrend', () => {
            ...
            const { result } = renderHook(() =>
                useAiAgentProductRecommendationsTrend(statsFilters, timezone),
            )
    ...
    describe('fetchAiAgentProductRecommendationsTrend', () => {
        it('should return data from fetchStatsMetricTrend', async () => {
            ...
            const result = await fetchAiAgentProductRecommendationsTrend(
                statsFilters,
                timezone,
            )
