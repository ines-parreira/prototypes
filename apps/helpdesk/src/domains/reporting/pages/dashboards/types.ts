...
import type { PerformanceChannelsVoiceChart } from 'domains/reporting/pages/performance/channels/voice/ChannelsVoiceReportConfig'
...
export type AvailableChartIds =
    ...
    | typeof PerformanceChannelsVoiceChart
