...
import { AnalyticsAiAgentSupportConfigurableBar } from '../AnalyticsAiAgentSupportConfigurableBar'
...
jest.mock(
    'pages/aiAgent/analyticsAiAgent/charts/AnalyticsAiAgentSupportConfigurableBar/DEPRECATED_SupportInteractionsComboChart',
    () => ({
...
jest.mock(
    ...
    () => ({
        useMoneySavedPerInteractionWithAutomate: () => 3.1,
    }),
)
...
describe('AnalyticsAiAgentSupportConfigurableBar', () => {
    const mockChartData = [
    ...
    it('should render the metric title', () => {
        render(<AnalyticsAiAgentSupportConfigurableBar />)
    ...
    it('should render the trend badge', () => {
        const { container } = render(<AnalyticsAiAgentSupportConfigurableBar />)
