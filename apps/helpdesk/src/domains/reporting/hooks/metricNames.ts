export const METRIC_NAMES = {
    ...
    AI_AGENT_DYNAMIC_SUPPORT_AGENT_TIME_SAVED:
        'ai-agent-dynamic-support-agent-time-saved',
    AI_AGENT_DYNAMIC_SUPPORT_AGENT_DECREASE_IN_FRT:
        'ai-agent-dynamic-support-agent-decrease-in-frt',
    ...
    AI_AGENT_DYNAMIC_ALL_AGENTS_AUTOMATION_RATE:
        'ai-agent-dynamic-all-agents-automation-rate',
    AI_AGENT_DYNAMIC_ALL_AGENTS_AUTOMATION_RATE_TIMESERIES:
    ...
    AI_AGENT_OVERVIEW_AUTOMATED_INTERACTIONS_PER_FEATURE:
        'ai-agent-overview-automated-interactions-per-feature',
    AI_AGENT_OVERVIEW_OVERALL_TIME_SAVED_BY_AGENT_PER_FEATURE:
    ...
    AI_AGENT_ALL_AGENTS_DECREASE_IN_FRT: 'ai-agent-all-agents-decrease-in-frt',
    AI_AGENT_ALL_AGENTS_FRT: 'ai-agent-all-agents-frt',
    AI_AGENT_ALL_AGENTS_RESOLUTION_TIME: 'ai-agent-all-agents-resolution-time',
    ...
    AI_JOURNEY_FAILED_MESSAGES: 'ai-journey-failed-messages',
    ...
    AI_AGENT_SALES_PERFORMANCE_TOTAL_SALES_PER_ENGAGEMENT_TYPE:
        'ai-agent-sales-performance-total-sales-per-engagement-type',
    AI_AGENT_SALES_PERFORMANCE_REVENUE_PER_INTERACTION_PER_ENGAGEMENT_TYPE:
    ...
    AI_AGENT_SALES_PERFORMANCE_CONVERSION_RATE_PER_CHANNEL:
        'ai-agent-sales-performance-conversion-rate-per-channel',
    AI_AGENT_SALES_PERFORMANCE_CONVERSION_RATE_PER_ENGAGEMENT_TYPE:
        'ai-agent-sales-performance-conversion-rate-per-engagement-type',
    AI_AGENT_SALES_PERFORMANCE_CONVERSION_RATE_PER_INTENT:
        'ai-agent-sales-performance-conversion-rate-per-intent',
    AI_AGENT_SHOPPING_ASSISTANT_REVENUE_PER_INTERACTION:
    ...
    AI_AGENT_SHOPPING_ASSISTANT_ORDERS_INFLUENCED_DRILL_DOWN:
        'ai-agent-shopping-assistant-orders-influenced-drill-down',
    ...
    AI_AGENT_SHOPPING_ASSISTANT_SUCCESS_RATE:
        'ai-agent-shopping-assistant-success-rate',
    // Agent Experience
...
export enum MetricScope {
    ...
    TicketsReplied = 'tickets-replied',
...
export const METRIC_NAMES_BY_SCOPE: Record<MetricScope, MetricName[]> = {
    ...
    [MetricScope.TicketsReplied]: [
        METRIC_NAMES.SUPPORT_PERFORMANCE_TICKETS_REPLIED,
    ...
    [MetricScope.TicketsClosed]: [
        METRIC_NAMES.SUPPORT_PERFORMANCE_CLOSED_TICKETS,
    ...
    [MetricScope.MessagesSent]: [
        METRIC_NAMES.SUPPORT_PERFORMANCE_MESSAGES_SENT,
    ...
    [MetricScope.FirstResponseTime]: [
        ...
        METRIC_NAMES.AI_AGENT_ALL_AGENTS_FRT,
    ],
    [MetricScope.ResolutionTime]: [
        METRIC_NAMES.SUPPORT_PERFORMANCE_MEDIAN_RESOLUTION_TIME,
        ...
        METRIC_NAMES.AI_AGENT_ALL_AGENTS_RESOLUTION_TIME,
    ],
    [MetricScope.OneTouchTickets]: [
        METRIC_NAMES.SUPPORT_PERFORMANCE_ONE_TOUCH_TICKETS,
    ...
    [MetricScope.MessagesPerTicket]: [
        METRIC_NAMES.SUPPORT_PERFORMANCE_MESSAGES_PER_TICKET,
    ],
    ...
    [MetricScope.Helpcenter]: [
        METRIC_NAMES.HELP_CENTER_ARTICLE_VIEW,
        METRIC_NAMES.HELP_CENTER_SEARCH_REQUESTED,
        METRIC_NAMES.HELP_CENTER_ARTICLE_VIEW_TIME_SERIES,
        METRIC_NAMES.HELP_CENTER_PERFORMANCE_BY_ARTICLE,
    ...
    [MetricScope.ConvertOrderConversion]: [
        ...
        METRIC_NAMES.CONVERT_STORE_REVENUE_TOTAL,
        METRIC_NAMES.CONVERT_CAMPAIGN_ORDER_TOTALS,
        METRIC_NAMES.CONVERT_REVENUE_SHARE_GRAPH,
    ...
    [MetricScope.ConvertCampaignOrderEvents]: [
        ...
        METRIC_NAMES.CONVERT_CAMPAIGN_EVENTS_TOTALS,
    ...
    [MetricScope.AiAgentDecreaseInFirstResponseTime]: [
        ...
        METRIC_NAMES.AI_AGENT_ALL_AGENTS_DECREASE_IN_FRT,
    ],
    ...
    [MetricScope.AiAgentTimeSaved]: [
        ...
        METRIC_NAMES.AI_AGENT_SUPPORT_AGENT_TIME_SAVED_TIMESERIES,
    ],
