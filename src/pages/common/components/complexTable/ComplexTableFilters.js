...
export const CallExpression = ({view, schemas, node, updateOperator, removeCondition, index, agents, tags, currentUser, updateFieldFilter, parentNode}) => {
    ...
    const operators = _get(property, 'meta.operators', BASIC_OPERATORS)
...
export default class ComplexTableFilters extends React.Component {
    ...
    render() {
        ...
        const exp = view.getIn(['filters_ast', 'body', 0, 'expression'], fromJS({})).toJS()
