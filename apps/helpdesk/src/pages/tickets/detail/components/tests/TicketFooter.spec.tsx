...
describe('<TicketFooter />', () => {
    ...
    it('should allow only internal notes for standalone ai agents with ticket read access', () => {
        mockUseStandaloneAiAccess.mockReturnValue(
            createMockStandaloneAiAccess({
    ...
    it('should allow public replies for standalone ai agents without ticket read access', () => {
        mockUseStandaloneAiAccess.mockReturnValue(
            createMockStandaloneAiAccess({
                isStandaloneAiAgent: true,
                ticketsView: {
