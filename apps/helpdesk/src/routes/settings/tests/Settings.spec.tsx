...
import { DefaultExportAccess as Access } from 'pages/settings/access/Access'
import { AgentUnavailabilityStatuses as AgentStatuses } from 'pages/settings/agentUnavailability/AgentStatuses'
import { DefaultExportAPIView as APIView } from 'pages/settings/api/APIView'
...
import { DefaultExportImportZendeskCreate as ImportZendeskCreate } from 'pages/settings/importZendesk/zendesk/ImportZendeskCreate'
import { DefaultExportImportZendeskDetail as ImportZendeskDetail } from 'pages/settings/importZendesk/zendesk/ImportZendeskDetail'
...
const testingMap = [
    ...
    },
    {
        callOrder: 20,
        exact: true,
        path: `${basePath}/import-zendesk/zendesk`,
        component: ImportZendeskCreate,
    },
    {
        callOrder: 21,
        exact: true,
        path: `${basePath}/import-zendesk/zendesk/:integrationId/:extra?`,
