...
declare namespace Components {
  namespace Schemas {
    ...
    export interface CategoryEntity {
      ...
      /**
       * mpath is added automatically for materialized-path. We can't easily set any decorators
       */
      mpath: string;
    }
    ...
    export interface CategoryTranslationEntity {
      ...
      localeId: number;
      locale: LocaleEntity;
      seoMeta: CategoryTranslationSeoMeta;
      creatorUserId?: number;
    }
    ...
    export interface CreateCategoryDto {
      /**
       * If the id is provided, the created category will be its child
       */
