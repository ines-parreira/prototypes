    ...
    describe('castGorgiasVideosForUnsupportedSources()', () => {
        it('should properly cast videos to hyperlinks and text', () => {
            ...
            const dataset: {
                ...
                // [video]
                {
                    rawHtml: `<figure><div class="gorgias-video-container" data-video-src="${randomUrls[0]}"></figure>`,
                    expectedHtmlHyperLinks: `<div><a href="${randomUrls[0]}">${randomUrls[0]}</a></div>`,
                    expectedHtmlNoHyperLinks: `<div>${randomUrls[0]}</div>`,
                },
                // [video] [video]
                {
                    rawHtml: `<figure><div class="gorgias-video-container" data-video-src="${randomUrls[0]}"></figure><div><br></div><figure><div class="gorgias-video-container" data-video-src="${randomUrls[1]}"></figure>`,
