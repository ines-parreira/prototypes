...
describe('api model utils', () => {
    ...
    describe('deepMapKeysToCamelCase', () => {
        it('should format params to camelCase', () => {
            expect(deepMapKeysToCamelCase({
                foo: 1,
                foo_bar: 2,
                _foobar: 3,
            })).toEqual({
        ...
        it('should format params to camelCase in a nested object', () => {
            expect(deepMapKeysToCamelCase({
                foo_bar: {
                    foo_bar: 1,
                },
        ...
        it('should format params to camelCase in array of objects', () => {
            expect(deepMapKeysToCamelCase({
                foo: [{
                    foo_bar: 1,
                }, {
        ...
        it.each([
            ...
            expect(deepMapKeysToCamelCase(value)).toEqual(value)
        })
    })
})
