...
describe('ConnectedChannelsContactFormView', () => {
    ...
    it('should render', () => {
        render(<ConnectedChannelsHelpCenterView />, {
            storeState: {
                ...defaultState,
                entities: {
                    contactForm: {
    ...
    it('should prioritize helpCenter.id over channel list id when both are available', async () => {
        ...
        render(
            <ConnectedChannelsHelpCenterView helpCenter={providedHelpCenter} />,
            {
                storeState: {
                    ...defaultState,
                    entities: {
    ...
    it('should toggle order management off', async () => {
        ...
        const { store } = render(<ConnectedChannelsHelpCenterView />, {
            path: '/:shopType/:shopName/connected-channels/help-center',
            initialEntries: [
                '/shopify/itay-store-two/connected-channels/help-center',
            ],
            storeState: {
                ...defaultState,
                entities: {
    ...
    it('should initialize with channel ID from URL parameter', async () => {
        ...
        render(<ConnectedChannelsHelpCenterView />, {
            path: '/:shopType/:shopName/connected-channels/help-center',
            initialEntries: [
                `/shopify/itay-store-two/connected-channels/help-center?channel-id=${channelId}`,
            ],
            storeState: {
                ...defaultState,
                entities: {
