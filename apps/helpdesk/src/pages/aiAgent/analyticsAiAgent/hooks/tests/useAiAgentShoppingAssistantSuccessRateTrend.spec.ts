...
import {
    fetchAiAgentShoppingAssistantSuccessRateTrend,
    useAiAgentShoppingAssistantSuccessRateTrend,
} from 'pages/aiAgent/analyticsAiAgent/hooks/useAiAgentShoppingAssistantSuccessRateTrend'
...
describe('useAiAgentShoppingAssistantSuccessRateTrend', () => {
    describe('useAiAgentShoppingAssistantSuccessRateTrend', () => {
    ...
    describe('fetchAiAgentShoppingAssistantSuccessRateTrend', () => {
        it('should return data from fetchStatsMetricTrend', async () => {
            ...
            const result = await fetchAiAgentShoppingAssistantSuccessRateTrend(
                statsFilters,
                timezone,
            )
