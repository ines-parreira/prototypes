export function getTranslations() {
    return {
        texts: {
            ...
            contactFormIntro:
                "Leave a message and we'll email you once we're online.",
        ...
        sspTexts: {
            ...
            april: 'Apr',
            articleRecommendationInputPlaceholder:
            ...
            errorGeneratingReturnPortalLink:
                'An error occurred generating the return portal link',
            errorSendingReportIssue:
                'Something went wrong while sending the report issue.',
            ...
            noCustomerAssociatedPhone:
                'No customer associated with this phone number',
            ...
            youWillGetRepliesHereAndByEmail:
                "Thanks! You'll get replies here and by email.",
