...
-   Update the content of `gorgias-chat-api.postman_collection.json` with the definitions from https://github.com/gorgias/gorgias-chat/blob/main/packages/api/postman/gorgias-chat-api.postman_collection.json
