    ...
    _renderIntegrationUsage = () => {
        ...
        if (includedIntegrations && usedIntegrations) {
            ...
            percentUsed = Math.round(
                (usedIntegrations * 100) / includedIntegrations
            )
            percentRemaining = 100 - percentUsed
        }
            ...
            <div>
                <div className={css['usage-numbers']}>
                    ...
                    <UncontrolledTooltip target="integrations-consumed">
                        Number of integrations used VS total number of
                        integrations available for your current plan.
                    </UncontrolledTooltip>
                </div>
        ...
        return (
            <div className="mb-5">
                ...
                {currentSubscription.isEmpty()
                    ? this._render_no_subscription()
                    : this._render_active_subscription()}
    ...
    _render_no_subscription() {
        return (
            <CardGroup className="mb-2">
                <Card
                    className={classnames(css['current-plan'], css['Missing'])}
                >
                    <CardBody>
                        <h4>No plan active plan</h4>
                        <div>
                            Please select a plan before updating you payment
                            method.
                        </div>
                    </CardBody>
                </Card>
...
export default connect(
    (state) => {
        ...
        return {
            ...
            currentPlan: billingSelectors.getPlan(
