...
jest.mock(
    'domains/reporting/pages/automate/aiSalesAgent/metrics/useDiscountCodesOfferedTrend',
)
...
jest.mock(
    'domains/reporting/pages/automate/aiSalesAgent/metrics/useDiscountCodesAppliedTrend',
)
