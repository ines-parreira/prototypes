...
import { DonutChartTooltip } from 'pages/stats/common/components/charts/DonutChart/DonutChartTooltip'

jest.mock(
    'pages/stats/common/components/charts/DonutChart/DonutChartTooltip.less',
    () => ({
