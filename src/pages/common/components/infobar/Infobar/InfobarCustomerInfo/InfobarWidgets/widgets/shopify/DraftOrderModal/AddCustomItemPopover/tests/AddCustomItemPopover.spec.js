...
describe('<AddCustomItemPopover/>', () => {
    ...
    describe('_onCancel()', () => {
        it.each([
            [ShopifyAction.CREATE_ORDER, EVENTS.SHOPIFY_CREATE_ORDER_CUSTOM_ITEM_POPOVER_CANCEL],
            [ShopifyAction.DUPLICATE_ORDER, EVENTS.SHOPIFY_DUPLICATE_ORDER_CUSTOM_ITEM_POPOVER_CANCEL],
