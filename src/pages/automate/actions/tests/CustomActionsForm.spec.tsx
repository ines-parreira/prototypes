...
import {generateNewCustomActionConfigurationFormInput} from '../utils'
...
const initialData = generateNewCustomActionConfigurationFormInput()

const renderComponent = () =>
    renderWithRouter(
        <Provider store={mockStore(defaultState)}>
            <QueryClientProvider client={queryClient}>
                <CustomActionsForm initialConfigurationData={initialData} />,
            </QueryClientProvider>
        </Provider>,
        {
...
describe('CustomActionsForm', () => {
    ...
    it('renders the form ', async () => {
        ...
        const nameInput = await findByLabelText('Action name', {exact: false})
