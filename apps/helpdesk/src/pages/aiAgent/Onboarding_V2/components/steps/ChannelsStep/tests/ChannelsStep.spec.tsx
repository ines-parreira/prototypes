...
} from 'pages/aiAgent/Onboarding_V2/components/steps/ChannelsStep/ChannelsStep'
import { usePreselectedChat } from 'pages/aiAgent/Onboarding_V2/components/steps/ChannelsStep/hooks/usePreselectedChat'
import { usePreselectedEmails } from 'pages/aiAgent/Onboarding_V2/components/steps/ChannelsStep/hooks/usePreselectedEmails'
import { useSelectedEmailsBeforeRedirect } from 'pages/aiAgent/Onboarding_V2/components/steps/ChannelsStep/hooks/useSelectedEmailsBeforeRedirect'
import { useShouldDisplayEmailIntegrationsLink } from 'pages/aiAgent/Onboarding_V2/components/steps/ChannelsStep/hooks/useShouldDisplayEmailIntegrationsLink'
...
jest.mock(
    'pages/aiAgent/Onboarding_V2/components/steps/ChannelsStep/hooks/usePreselectedChat',
)
const usePreselectedChatMock = assumeMock(usePreselectedChat)

jest.mock(
    'pages/aiAgent/Onboarding_V2/components/steps/ChannelsStep/hooks/usePreselectedEmails',
)
const usePreselectedEmailsMock = assumeMock(usePreselectedEmails)

jest.mock(
    'pages/aiAgent/Onboarding_V2/components/steps/ChannelsStep/hooks/useShouldDisplayEmailIntegrationsLink',
)
...
jest.mock(
    'pages/aiAgent/Onboarding_V2/components/steps/ChannelsStep/hooks/useSelectedEmailsBeforeRedirect',
)
...
describe('ChannelsStep', () => {
    ...
    describe('ChannelsStep - loading state', () => {
        ...
        it('should render loading state when the onboarding data is being fetched', () => {
            ...
            // Check that the Next button is disabled during loading
