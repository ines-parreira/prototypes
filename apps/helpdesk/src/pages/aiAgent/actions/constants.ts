...
export const EMPTY_STATE_BANNER_ACTIONS_DESCRIPTION =
    'Allow AI Agent to perform Actions such as canceling orders, updating shipping addresses, and more. Actions can only be performed with AI Agent on Email.'
