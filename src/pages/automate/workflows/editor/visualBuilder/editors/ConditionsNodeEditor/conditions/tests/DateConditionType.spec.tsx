...
describe('<DateConditionType />', () => {
    it('should render greaterThan/lessThan disabled date condition ', () => {
        renderWithStore(
            <DateConditionType
                condition={{lessThan: [{var: ''}, '2024-08-28T18:46:09.178Z']}}
                onChange={jest.fn()}
                isDisabled
            />,
            {}
    ...
    it('should render greaterThanInterval/lessThanInterval disabled date condition ', () => {
        ...
        expect(screen.getAllByRole('menu', {hidden: true})[0]).toHaveAttribute(
            'aria-hidden',
            'true'
        )
        ...
        expect(screen.getAllByRole('menu', {hidden: true})[1]).toHaveAttribute(
            'aria-hidden',
            'true'
        )
    })
