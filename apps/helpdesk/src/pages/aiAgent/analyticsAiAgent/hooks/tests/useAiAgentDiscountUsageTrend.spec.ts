...
import {
    fetchAiAgentDiscountUsageTrend,
    useAiAgentDiscountUsageTrend,
} from 'pages/aiAgent/analyticsAiAgent/hooks/useAiAgentDiscountUsageTrend'
...
assumeMock(discountUsageQueryV2Factory)

describe('aiAgentDiscountUsageTrend', () => {
    describe('useAiAgentDiscountUsageTrend', () => {
        it('should return data from useStatsMetricTrend', () => {
            ...
            const { result } = renderHook(() =>
                useAiAgentDiscountUsageTrend(statsFilters, timezone),
            )
    ...
    describe('fetchAiAgentDiscountUsageTrend', () => {
        it('should return data from fetchStatsMetricTrend', async () => {
            ...
            const result = await fetchAiAgentDiscountUsageTrend(
                statsFilters,
                timezone,
            )
