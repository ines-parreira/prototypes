...
jest.mock(
    'pages/integrations/integration/components/gorgias_chat/hooks/useConvertBundleInChatSnippetEnabled',
    () => ({
...
jest.mock(
    'pages/integrations/integration/components/gorgias_chat/hooks/useConvertBundleInstallationSnippet',
    () => ({
