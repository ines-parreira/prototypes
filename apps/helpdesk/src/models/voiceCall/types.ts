...
export enum MonitoringErrorCode {
    ...
    TRANSFERRING_TO_QUEUE = 'TRANSFERRING_TO_QUEUE',
    HANDLING_CALL = 'HANDLING_CALL',
    ADMIN_HANDLING_CALL = 'ADMIN_HANDLING_CALL',
    ALREADY_MONITORING_CALL = 'ALREADY_MONITORING_CALL',
    AGENT_BUSY = 'AGENT_BUSY',
    OTHER_AGENT_MONITORING_CALL = 'OTHER_AGENT_MONITORING_CALL',
    CALL_FORWARDED_TO_EXTERNAL_NUMBER = 'CALL_FORWARDED_TO_EXTERNAL_NUMBER',
}
