...
export class ManageRequests extends React.Component<Props, State> {
    ...
    render() {
        ...
        return (
            <div>
                <div className="manage-requests d-flex justify-content-between">
                    <h1>
                        <i className="fa fa-fw fa-magic blue mr-2"/>
                        Manage Requests (experimental)
                    </h1>
                    <div className="pull-right">
                        <div className="manage-requests-bulk-actions">
                            <Button
