...
describe('knowledgeTicketsResourceCount', () => {
    it('should build query without sorting', () => {
        ...
        const query = knowledgeTicketsResourceCount.build(ctx)
...
describe('knowledgeTicketsResourceCountQueryV2Factory', () => {
    it('should create a query from context', () => {
        ...
        const query = knowledgeTicketsResourceCountQueryV2Factory(ctx)
