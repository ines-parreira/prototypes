export enum SegmentEvent {
    ...
    ChatMigrationBannerViewed = 'chat-migration-banner-viewed',
    ChatMigrationBusinessHoursToggled = 'chat-migration-business-hours-toggled',
    ChatMigrationOptInConfirmed = 'chat-migration-opt-in-confirmed',
    ChatMigrationOptOutClicked = 'chat-migration-opt-out-clicked',
    ChatMigrationPreviewModeSwitched = 'chat-migration-preview-mode-switched',
    ...
    CopilotClosed = 'copilot-closed',
    CopilotConversationStarted = 'copilot-conversation-started',
    CopilotConversationStartersShown = 'copilot-conversation-starters-shown',
    CopilotOpened = 'copilot-opened',
    CopilotThreadSwitched = 'copilot-thread-switched',
    ...
    InfobarSearchUsedV2 = 'infobar-search-used-v2',
    ...
    RealtimeConnectivityBannerAutoHidden = 'realtime/connectivity-banner-auto-hidden',
    RealtimeConnectivityBannerHidden = 'realtime/connectivity-banner-hidden',
    ...
    SearchQueryRankedV2 = 'search-query-ranked-v2',
