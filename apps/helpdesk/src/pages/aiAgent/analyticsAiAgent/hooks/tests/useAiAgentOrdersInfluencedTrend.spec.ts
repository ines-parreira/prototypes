...
import {
    fetchAiAgentOrdersInfluencedTrend,
    useAiAgentOrdersInfluencedTrend,
} from 'pages/aiAgent/analyticsAiAgent/hooks/useAiAgentOrdersInfluencedTrend'
...
describe('useAiAgentOrdersInfluencedTrend', () => {
    describe('useAiAgentOrdersInfluencedTrend', () => {
        it('should return data from useMetricTrend', () => {
            ...
            const { result } = renderHook(() =>
                useAiAgentOrdersInfluencedTrend(statsFilters, timezone),
            )
    ...
    describe('fetchAiAgentOrdersInfluencedTrend', () => {
        it('should return data from fetchMetricTrend', async () => {
            ...
            const result = await fetchAiAgentOrdersInfluencedTrend(
                statsFilters,
                timezone,
            )
