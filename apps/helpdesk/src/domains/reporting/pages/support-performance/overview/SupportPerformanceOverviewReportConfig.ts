...
import { MessagesPerTicketTrendCard } from 'domains/reporting/pages/support-performance/overview/charts/MessagesPerTicketTrendCard'
...
import { MessagesSentGraph } from 'domains/reporting/pages/support-performance/overview/charts/MessagesSentGraph'
import { MessagesSentTrendCard } from 'domains/reporting/pages/support-performance/overview/charts/MessagesSentTrendCard'
import { OneTouchTicketsTrendCard } from 'domains/reporting/pages/support-performance/overview/charts/OneTouchTicketsTrendCard'
import { OpenTicketsTrendCard } from 'domains/reporting/pages/support-performance/overview/charts/OpenTicketsTrendCard'
import { TicketHandleTimeTrendCard } from 'domains/reporting/pages/support-performance/overview/charts/TicketHandleTimeTrendCard'
import { TicketsClosedTrendCard } from 'domains/reporting/pages/support-performance/overview/charts/TicketsClosedTrendCard'
import { TicketsCreatedTrendCard } from 'domains/reporting/pages/support-performance/overview/charts/TicketsCreatedTrendCard'
...
import { TicketsRepliedGraph } from 'domains/reporting/pages/support-performance/overview/charts/TicketsRepliedGraph'
import { TicketsRepliedTrendCard } from 'domains/reporting/pages/support-performance/overview/charts/TicketsRepliedTrendCard'
...
export const SupportPerformanceOverviewReportConfig: ReportConfig<OverviewChart> =
    {
        ...
        charts: {
            ...
            [OverviewChart.MedianResponseTimeTrendCard]: {
                ...
                label: OverviewMetricConfig[OverviewMetric.MedianResponseTime]
                    .title,
                csvProducer: [
                    {
                        type: DataExportFormat.Trend,
                ...
                description:
                    OverviewMetricConfig[OverviewMetric.MedianResponseTime].hint
                        .title,
                chartType: ChartType.Card,
            },
