...
const METRIC_OPTIONS: MetricOption[] = [
    ...
    { id: 'automated-interactions', label: 'Automated interactions' },
...
type AllAgentsLineChartProps = {
    value?: string
    trend?: number
}

export const AllAgentsLineChart = ({
    value = '28%',
    trend = 2,
}: AllAgentsLineChartProps) => {
            ...
            <ResponsiveContainer width="100%" height={280}>
                <AreaChart data={CHART_DATA}>
                    ...
                    <YAxis
                        ...
                        tickFormatter={renderTickLabelAsPercentage}
                    />
                    <Area
                        type="natural"
                        dataKey="value"
