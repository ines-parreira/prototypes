...
const GorgiasChatIntegrationVisibilityControls = forwardRef<
    GorgiasChatIntegrationVisibilityControlsHandle,
    Props
>(
    (
        {integration, open, isOpen, isUpdate, canSubmit, onSubmit, onValidate},
        ref
    ) => {
        ...
        const installation: Maybe<GorgiasChatMetaInstallation> =
            installationMeta ? installationMeta.toJS() : undefined
        ...
        const isDirty =
            ...
            conditions.length !==
                installation?.visibility?.conditions?.length ||
            conditions.some(
                (condition, index) =>
                    condition.value !==
        ...
        return (
            ...
            >
                ...
                >
                    <span>
                        {visibilityMethodCaptions[initialVisibilityMethod]}
                    </span>
                    <span
                        ...
                        <div className={css.visibilityControls}>
                            ...
                            {hasIncompatibleConditions && (
                                ...
                                >
                                    ...
                                    select "At least one condition" filter or
                                    remove a condition.
                                </Alert>
                            )}
...
export default GorgiasChatIntegrationVisibilityControls
