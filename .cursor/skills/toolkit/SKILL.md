---
name: toolkit
description: Guide for using the @gorgias/toolkit utility package. Use when working with shared TypeScript utilities from @gorgias/toolkit, including Schema utilities, duration helpers, package exports, supported APIs, or usage examples.
---
