...
description: Analytics copilot prototype. Takes a natural language question about customer metrics and determines whether it can be answered with existing scopes in the Notion "New Stats API Metrics" database. If yes, generates the TypeScript query or queries. If not, explains what is missing. Designed for engineers and PMs exploring what customer-facing analytics questions we can already surface.
---
