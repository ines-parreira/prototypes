...
import {formatPrice} from '../../../../../../../../../../../business/shopify/order'
...
export default class ShippingPopover extends React.PureComponent<Props, State> {
    ...
    componentDidUpdate(prevProps: Props, prevState: State) {
        ...
        if (onOpen) {
            ...
            segmentTracker.logEvent(segmentTracker.EVENTS.SHOPIFY_DUPLICATE_ORDER_SHIPPING_POPOVER_OPEN)
        } else if (onClose) {
    ...
    _onPriceChange = (event: SyntheticInputEvent<HTMLInputElement>) => {
    ...
    _onSubmit = (event: SyntheticEvent<HTMLFormElement>) => {
        ...
        segmentTracker.logEvent(segmentTracker.EVENTS.SHOPIFY_DUPLICATE_ORDER_SHIPPING_POPOVER_APPLY, {
            type,
        })
    }
    ...
    _onRemove = () => {
        ...
        segmentTracker.logEvent(segmentTracker.EVENTS.SHOPIFY_DUPLICATE_ORDER_SHIPPING_POPOVER_REMOVE)
    }

    _onClose = () => {
        this._toggle()
        segmentTracker.logEvent(segmentTracker.EVENTS.SHOPIFY_DUPLICATE_ORDER_SHIPPING_POPOVER_CLOSE)
    }
