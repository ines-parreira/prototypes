...
import CustomInstallationCard from 'pages/integrations/common/components/CustomInstallationCard'
import InstallOnIntegrationsCard from 'pages/integrations/common/components/InstallOnIntegrationsCard'
