import { Box, Button, Menu, MenuItem, SubMenu, Text } from '@gorgias/axiom'
...
export function AudioPlayer({
    ...
    return (
        <div className={css.playerContainer}>
            ...
            <Button
                icon={isPlaying ? 'media-pause-circle' : 'media-play-circle'}
                variant="secondary"
            ...
            >
                ...
                />
                <SubMenu label="Playback speed" leadingSlot="media-play-circle">
