...
class ChatIntegrationDetail extends React.Component {
    ...
    componentDidUpdate() {
        $(this.refs.companyIconTooltip).popup({
            inline: true,
            position: 'top left',
            offset: -11
        })
    ...
    _renderInstructions = (isUpdate, isSubmitting) => {
        ...
        return (
            <div>
                ...
                <p>
                    To add or update the chat to your website, add the following code before the <kbd>{'</body>'}</kbd> on your page:
                </p>
                <div className={css.snippet}>
                    ...
                    <textarea className="ui info message" id="chat-snippet" value={this._renderSnippet(integration)} rows="12" readOnly></textarea>
                ...
                <p>
                    This chat is provided through a 3rd party called Smooch, at no additional cost. You can send user data to better
                    identify who you are talking to. Check out <a href="http://docs.smooch.io/javascript/" target="_blank">their documentation</a> to learn how to do it.
                </p>
            </div>
        )
    }
                                    ...
                                    label={
                                        <span>
                                            ...
                                            <div className="ui inverted popup">
                                                The image must have a square format.
                                            </div>
                                        </span>
                                    }
                                />
