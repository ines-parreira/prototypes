...
const METRIC_OPTIONS: MetricOption[] = [
    ...
    { id: 'orders-ifluenced', label: 'Orders influenced' },
    { id: 'resolved-interactions', label: 'Resolved interactions' },
    { id: 'revenue-per-interaction', label: 'Revenue per interaction' },
]
