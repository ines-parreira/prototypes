...
export const REPORT_ISSUE_PREVIEW_ORDER_NAME = '#1001'

export const REPORT_ISSUE_PREVIEW_ORDER: GorgiasChatPreviewOrder = {
    id: 1001,
    email: '',
    name: REPORT_ISSUE_PREVIEW_ORDER_NAME,
    order_number: 1001,
    ...
    fulfillments: [
        {
            id: 1,
            name: `${REPORT_ISSUE_PREVIEW_ORDER_NAME}.1`,
...
export const REPORT_ISSUE_PREVIEW_ORDERS: GorgiasChatPreviewOrdersOptions = {
    orders: {
        [REPORT_ISSUE_PREVIEW_ORDER_NAME]: REPORT_ISSUE_PREVIEW_ORDER,
    },
    flows: {
        track_order: false,
        cancel_order: false,
