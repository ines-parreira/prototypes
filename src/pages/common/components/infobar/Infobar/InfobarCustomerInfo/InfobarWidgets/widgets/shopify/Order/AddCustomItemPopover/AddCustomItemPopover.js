...
export default class AddCustomItemPopover extends React.PureComponent<Props, State> {
    ...
    componentDidUpdate(prevProps: Props, prevState: State) {
        ...
        if (onOpen) {
            ...
            segmentTracker.logEvent(segmentTracker.EVENTS.SHOPIFY_DUPLICATE_ORDER_CUSTOM_ITEM_POPOVER_OPEN)
        } else if (onClose) {
    ...
    _onSubmit = (event: SyntheticEvent<HTMLFormElement>) => {
        ...
        segmentTracker.logEvent(segmentTracker.EVENTS.SHOPIFY_DUPLICATE_ORDER_CUSTOM_ITEM_POPOVER_SAVE)
    }
    ...
    _onCancel = () => {
        ...
        segmentTracker.logEvent(segmentTracker.EVENTS.SHOPIFY_DUPLICATE_ORDER_CUSTOM_ITEM_POPOVER_CANCEL)
    }
