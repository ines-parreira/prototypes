    ...
    describe('responseSourceType()', () => {
        it.each([
            ...
            (lastMessage: TicketMessage) => {
                ...
                ).toEqual(TicketMessageSourceType.InternalNote)
            }
        )
        ...
        it.each([
            ...
            (eventType: PhoneIntegrationEvent) => {
                ...
                expect(
                    ticketConfig.responseSourceType(messages, via, events)
                ).toEqual(TicketMessageSourceType.Phone)
            }
        )
        ...
        it.each([
            ...
            (eventType: PhoneIntegrationEvent) => {
                ...
                expect(
                    ticketConfig.responseSourceType(messages, via, events)
                ).toEqual(TicketMessageSourceType.Email)
            }
        )
        ...
        it('should return SMS channel if the last message is an SMS on a Twilio ticket', () => {
            ...
            expect(
                ticketConfig.responseSourceType(messages, via, events)
            ).toEqual(TicketMessageSourceType.Sms)
        })
        ...
        it.each([
            ...
            (sourceType) => {
                ...
                expect(
                    ticketConfig.responseSourceType(messages, via, events)
                ).toEqual(TicketMessageSourceType.FacebookMentionComment)
            }
        )
        ...
        it.each([
            ...
            (sourceType) => {
                ...
                expect(
                    ticketConfig.responseSourceType(messages, via, events)
                ).toEqual(TicketMessageSourceType.TwitterTweet)
            }
        )
    })
