...
import {
    fetchAiAgentDiscountCodesAppliedTrend,
    useAiAgentDiscountCodesAppliedTrend,
} from 'pages/aiAgent/analyticsAiAgent/hooks/useAiAgentDiscountCodesAppliedTrend'
...
assumeMock(appliedDiscountCodesQueryV2Factory)

describe('aiAgentDiscountCodesAppliedTrend', () => {
    describe('useAiAgentDiscountCodesAppliedTrend', () => {
        it('should return data from useStatsMetricTrend', () => {
            ...
            const { result } = renderHook(() =>
                useAiAgentDiscountCodesAppliedTrend(statsFilters, timezone),
            )
    ...
    describe('fetchAiAgentDiscountCodesAppliedTrend', () => {
        it('should return data from fetchStatsMetricTrend', async () => {
            ...
            const result = await fetchAiAgentDiscountCodesAppliedTrend(
                statsFilters,
                timezone,
            )
