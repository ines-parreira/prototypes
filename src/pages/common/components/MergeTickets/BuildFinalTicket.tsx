    ...
    return (
        <div>
            <p>
                ...
                fields in blue will be kept. All fields not displayed here are
                either identical on both tickets, or will be computed
                automatically.
            </p>
            {nothingIsDifferent ? (
            ...
            {subjectsAreDifferent ? (
                <BinaryChoiceField
                    ...
                    onChange={(subject: string) =>
                        updateFinalTicket(finalTicket.set('subject', subject))
                    }
                />
            ) : null}
            {customersAreDifferent ? (
                    ...
                    options={[
                        {
                            label: (
                                <span>
                                    <Avatar
                                        name={
                                            sourceAssignee.get('name') as string
                                        }
                        ...
                        },
                        {
                            label: (
                                <span>
                                    <Avatar
                                        name={
                                            targetAssignee.get('name') as string
                                        }
