...
import { ProductTableBodyCell } from 'pages/stats/voice-of-customer/components/ProductInsightsTable/ProductTable'
...
jest.mock(
    'pages/stats/voice-of-customer/components/ProductInsightsTable/ProductInsightsTableConfig',
    () => ({
        ...jest.requireActual(
            'pages/stats/voice-of-customer/components/ProductInsightsTable/ProductInsightsTableConfig',
        ),
...
jest.mock(
    'pages/stats/voice-of-customer/components/ProductInsightsTable/ProductTable',
)
