...
describe('current account selectors', () => {
    ...
    it('getCurrentSubscription', () => {
        expect(selectors.getCurrentSubscription(state))
            .toEqualImmutable(state.currentAccount.get('current_subscription'))
    ...
    it('shouldPayWithShopify', () => {
        expect(selectors.shouldPayWithShopify(
    ...
    it('getShopifyBillingStatus', () => {
        expect(selectors.getShopifyBillingStatus(
            setStateWith(state, ['meta', 'shopify_billing', 'active'], true))
        ).toBe('active')
        expect(selectors.getShopifyBillingStatus(
            setStateWith(state, ['meta', 'shopify_billing', 'active'], false))
        ).toBe('inactive')
