...
class LocalStorageManager {
    integrations = {
        [IntegrationType.ShopifyIntegrationType]: {
            draftOrders: {
                ...
                setMapItem(key: string, value: string) {
    ...
    static _getMap(key: string): Map<string, any> {
