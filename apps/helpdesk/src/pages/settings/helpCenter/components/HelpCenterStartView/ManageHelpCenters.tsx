...
export const ManageHelpCenters = ({
    ...
    const duplicateHelpCenter = useCallback(
        (helpCenter: HelpCenter): void => {
            const showError = () =>
                toast.error(
                    `Something went wrong. We could not duplicate ${helpCenter.name}.`,
                )
            ...
            const loadingToastId = toast.info(
                `Duplicating ${helpCenter.name}. It may take up to a minute.`,
                { duration: Infinity },
            )
            ...
            void client
                ...
                .then(({ data: newHelpCenter }) => {
                    ...
                    toast.success(`${newHelpCenter.name} successfully created.`)
