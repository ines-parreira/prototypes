...
const AutomateExploreDataModal = forwardRef<
    ...
    Props
>(({firstResponseTime, resolutionTime, monthlySupportTickets}, ref) => {
    ...
    const annualSalaryCostValue = costPerTicket
        ? (costPerTicket * annualSalaryMultiplier).toLocaleString(undefined, {
              maximumFractionDigits: 2,
          })
    ...
    const onCostTypeChange = (val: AccountSettingAgentCostType) => {
        setCostType(val)
        setCostValue(val === 'yearly' ? annualSalaryCostValue : hourlyCostValue)
    }
                    ...
                    <div>
                        <Label className={css.label}>
                            ...
                            >
                                ...
                                support agent, in USD. By default, we use the
                                industry average hourly rate ($
                                {defaultAgentHourlyRate}). Wage information will
                                not be stored in our system.
                            </Tooltip>
                        </Label>
                    ...
                    <div>
                        <Label className={css.label}>
                            ...
                            <Tooltip
                                ...
                                className={css.tooltip}
                            >
                                Total number of support tickets in the last 28
                                days on your helpdesk.
                            </Tooltip>
                        </Label>
                        <InputField
                        ...
                        <div>
                            <Label className={css.label}>
                                ...
                                <Tooltip
                                    ...
                                    className={css.tooltip}
                                >
                                    Resolution time for non-automated tickets in
                                    the last 28 days pulled from Support
