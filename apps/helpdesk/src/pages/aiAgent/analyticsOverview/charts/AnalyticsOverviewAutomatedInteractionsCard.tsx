...
import { useOverallAutomatedInteractionsTrend } from 'pages/aiAgent/analyticsOverview/hooks/useOverallAutomatedInteractionsTrend'
...
export const AnalyticsOverviewAutomatedInteractionsCard = ({
    ...
    const trendCardProps = useReportingTrendCardProps({
        useTrend: useOverallAutomatedInteractionsTrend,
