...
export enum FeatureFlagKey {
    ...
    OpportunitiesKnowledgeConflicts = 'linear.project_proactively-surface-opportunities.enable-knowledge-conflicts',
    ...
    UseVoiceSpamDetection = 'use-voice-spam-detection',
