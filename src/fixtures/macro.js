export const macros = [
    {
        ...
        actions: [{
            ...
            arguments: {
                ...
                params: [{editable: false, key: 'user_id', value: '{ticket.requester.id}'}]
            },
            name: 'http'
        }],
