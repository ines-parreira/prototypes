...
describe('Accuracy', () => {
    ...
    it('should render AccuracyFilter component just fine if value is undefined', () => {
        renderWithStore(
            <AccuracyFilter
                onRemove={mockedRemove}
                value={undefined}
        ...
        expect(
            screen.getByText(FilterLabels[FilterKey.Accuracy]),
        ).toBeInTheDocument()
    ...
    it('should remove the Accuracy filter', () => {
        renderComponent()
    ...
    describe('AccuracyFilterWithState', () => {
        it('should render AccuracyFilterWithState component', () => {
            const spy = jest.spyOn(
                statsSlice,
                'mergeStatsFiltersWithLogicalOperator',
            )

            renderWithStore(<AccuracyFilterWithState />, defaultState)
            ...
            expect(spy).toHaveBeenCalledWith({
                [FilterKey.Accuracy]: withLogicalOperator([]),
            })
        })
    })

    describe('AccuracyFilterWithSavedState', () => {
        it('should render AccuracyFilterWithSavedState component', () => {
            ...
            renderWithStore(<AccuracyFilterWithSavedState />, defaultState)
            userEvent.click(screen.getByText(FILTER_VALUE_PLACEHOLDER))
            userEvent.click(screen.getByText(FILTER_SELECT_ALL_LABEL))
